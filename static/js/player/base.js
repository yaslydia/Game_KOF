...
export class Player extends GameObject {
  ...
  render() {
    // Using triangles with different colors to represent players' collision box
    // this.ctx.fillStyle = "blue";
    // this.ctx.fillRect(this.x, this.y, this.width, this.height);

    // if (this.direction > 0) {
    //   this.ctx.fillStyle = "red";
    //   this.ctx.fillRect(this.x + 120, this.y + 40, 100, 20); // player0 fist position
    // } else {
    //   this.ctx.fillStyle = "red";
    //   this.ctx.fillRect(this.x + this.width - 120 - 100, this.y + 40, 100, 20); // player1 fist position
    // }
